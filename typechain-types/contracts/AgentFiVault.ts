...
export declare namespace AgentFiVault {
...
export interface AgentFiVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BPS"
      | "CREATOR_ALLOC"
...
export interface AgentFiVault extends BaseContract {
  connect(runner?: ContractRunner | null): AgentFiVault;
  waitForDeployment(): Promise<this>;

  interface: AgentFiVaultInterface;
